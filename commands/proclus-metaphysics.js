...
const bookRef = require('./books/proclus-elementsofmetaphysics.json');            //<----CHANGE THE BOOK REF

module.exports = {

    //-------------------------------------------------
	data: new SlashCommandBuilder()
		.setName('proclus-metaphysics')                                      //<----SET THE command name to be  the same as this file's name.js
