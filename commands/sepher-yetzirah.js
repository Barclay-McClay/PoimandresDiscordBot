...
const bookRef = require('./books/sepher-yetzirah.json');            //<----CHANGE THE BOOK REF

module.exports = {

    //-------------------------------------------------
	data: new SlashCommandBuilder()
		.setName('sepher-yetzirah')                                      //<----SET THE command name to be  the same as this file's name.js
